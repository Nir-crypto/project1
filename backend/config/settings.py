...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-reward-based-erudition')
...
DB_ENGINE = os.getenv('DB_ENGINE', 'mysql').lower().strip()
if DB_ENGINE == 'sqlite':
    DATABASES = {
        'default': {
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('MYSQL_DB', 'reward_erudition'),
